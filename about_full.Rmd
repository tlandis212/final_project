...
# save(full_voter, file = "full_voter.RData")

# Load in full_voter

# full_voter <- load("raw_data/full_voter.Rdata")
...
# 
#    # Each voters' row should look identical except for the elections column.
#    # Drop columns that prevent that from happening. This is necessary for
#    # pivoting wider
# 
